...
parser = argparse.ArgumentParser(description="Download APOD metadata using APOD API service.")
...
def main():
    ...
    for yyyy in range(earliest_year, latest_year+1):
        ...
        print("Year: {} - Writing {} records to {}".format(yyyy, len(response_json), outfile))
